...
const NavBar = () => {
  ...
  return (
    <div className="flex flex-col absolute w-[100%] z-[2]">
      <div
        className="flex items-center gap-8 p-2 px-16 justify-between bg-gradient-to-b from-black 
    to-transparent  hover:bg-black transition-colors duration-700 border-b border-black"
      >
        <div className="flex items-center gap-4">
          ...
          <ul className="flex">
            <li>
              <Button
                variant="link"
                className="text-white decoration-transparent font-bold text-md hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-br hover:from-red-500 hover:to-rose-300 transition-colors"
              >
                Home
              </Button>
            </li>
            ...
            <li>
              <Button
                variant="link"
                className="text-white decoration-transparent font-bold text-md hover:text-transparent hover:text-red-400 transition-colors gap-1"
                onMouseEnter={onOpen}
                onMouseLeave={onOpen}
              >
                <span>Products</span>
